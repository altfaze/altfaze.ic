        ...
        <div className="container max-w-[64rem]">
          ...
          <div className="bg-blue-50 dark:bg-blue-950 p-8 rounded-lg text-center">
            <p className="text-lg text-muted-foreground mb-6">
              Altfaze is built by a passionate team of engineers, designers, and entrepreneurs committed to revolutionizing the freelance industry. We combine deep expertise in technology, business, and marketplace dynamics to create the best platform for our community.
            </p>
            <p className="text-lg text-muted-foreground">
              Our team works 24/7 to ensure your success. Every feature, every fix, every update is driven by feedback from our community of freelancers and clients.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-8">
            <div className="flex gap-6">
              <div className="flex-shrink-0">
                <div className="flex items-center justify-center h-12 w-12 rounded-full bg-blue-600 text-white font-bold">2023</div>
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-2">Founded</h3>
                <p className="text-muted-foreground">Altfaze is launched with a mission to revolutionize freelancing in India.</p>
              </div>
            </div>

            <div className="flex gap-6">
              <div className="flex-shrink-0">
                <div className="flex items-center justify-center h-12 w-12 rounded-full bg-green-600 text-white font-bold">2024</div>
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-2">Rapid Growth</h3>
                <p className="text-muted-foreground">5,000+ freelancers and 2,000+ clients join Altfaze. ₹5 Cr in transactions processed.</p>
              </div>
            </div>

            <div className="flex gap-6">
              <div className="flex-shrink-0">
                <div className="flex items-center justify-center h-12 w-12 rounded-full bg-purple-600 text-white font-bold">2025</div>
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-2">Expansion</h3>
                <p className="text-muted-foreground">Mobile app launched, expanded to other countries, introduced new features for enterprise clients.</p>
              </div>
            </div>

            <div className="flex gap-6">
              <div className="flex-shrink-0">
                <div className="flex items-center justify-center h-12 w-12 rounded-full bg-orange-600 text-white font-bold">2026</div>
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-2">Market Leader</h3>
                <p className="text-muted-foreground">Altfaze becomes the #1 freelance platform for Indian talent. AI-powered matching, advanced features, and 10K+ active freelancers.</p>
              </div>
            </div>
          </div>
        </div>
